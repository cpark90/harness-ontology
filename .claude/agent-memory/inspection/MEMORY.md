...
- [연합 lockstep](federation-lockstep.md) — 중앙 core 추가·**파일 이동** 모두 recipe catalog 동반 필요; push 전 로컬 8-recipe federate 게이트(staging central symlink); recipes CI 매트릭스는 2건뿐이라 CI green≠회귀 부재
